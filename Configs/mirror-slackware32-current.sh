...
# Your name/email:
BUILDER=${BUILDER:-"Fela  <ahlr_2000@yahoo.com>"}
...
SLACKROOTDIR=${SLACKROOTDIR:-"/mnt/sda3/Slackware"}
...
EXCLUDES=${EXCLUDES:-"--exclude pasture --exclude source"}
...
DVD_EXCLUDES=${DVD_EXCLUDES:-"-x ./source -x ./extra/source"}
