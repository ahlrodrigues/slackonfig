...
**Usage:**
----------
  Baixe o **SLACKONFIG** e rodeo como root para realizar todas as funções programadas por padrão ou escolha no diretório /Configs o script que mais lhe agradar.
